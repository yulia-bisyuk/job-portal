...
export const styles = {
  ...
  actionButton:
    'flex px-[6px] py-[14px] hover:bg-lightGreen transition duration-300 rounded',
  textInput:
  ...
  heading1:
    'font-bold sm:text-[48px] ss:text-[36px] text-[30px] sm:leading-normal leading-10 w-full mb-[20px] ss:mb-[28px]',
  heading2:
    'font-semibold text-center sm:text-[30px] ss:text-[24px] text-[18px] sm:leading-normal leading-10 w-full mb-[20px] ss:mb-[28px]',
  heading3:
    'font-semibold text-center sm:text-[24px] ss:text-[18px] text-[12px] sm:leading-normal leading-10 w-full mb-[20px] ss:mb-[28px]',
  heading4:
    ' font-semibold sm:text-[18px] ss:text-[16px] text-[14px] sm:leading-normal leading-10',
  paragraph:
    'font-normal text-[12px] ss:text-[16px] sm:text-[20px] leading-[30px] w-full ',
